...
import com.dispalt.tagless.TwoWaySimulator.*
import com.dispalt.tagless.boopickle.boopickleTests.{ SafeAlg2, TestClass }
import com.dispalt.tagless.util.WireProtocol
//import com.dispalt.tagless.boopickle.boopickleTests.{ Bar, Baz, Foo, FooId, SafeAlg2 }
import com.dispalt.tagless.boopickle.boopickleTests.{ Bar, Baz, Foo, FooId }
